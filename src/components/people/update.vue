          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="main_form">
                ...
                />
                <input type="hidden" v-model="people.people_id" />
                <input type="hidden" v-model="people.old_password" />
  ...
  methods: {
    async updateBtn() {
      ...
      if (this.people.name == "") {
        ...
        const result = await axios.post(
          "http://localhost/iubenda_backend/api/admin/people/update.php",
          {
            ...
            password: this.people.pass,
            old_password: this.people.old_password,
          }
        );
        // console.log(result);
    ...
    async loadData() {
      ...
      const get_result = await axios.get(
        "http://localhost/iubenda_backend/api/admin/people/find.php?id=" +
          this.$route.params.id
      );
      // console.log(result);
      // this.people = get_result.data;
      this.people.name = get_result.data.name;
      this.people.email = get_result.data.email;
      this.people.gender = get_result.data.gender;
      this.people.date_of_birth = get_result.data.date_of_birth;
      this.people.com_id = get_result.data.com_id;
      this.people.position = get_result.data.position;
      this.people.account_status = get_result.data.account_status;
      this.people.people_id = get_result.data.people_id;
      //this.people.password = "";
      this.people.old_password = get_result.data.password;
