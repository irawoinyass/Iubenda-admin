          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="main_form">
                ...
                />
                <input type="hidden" v-model="company.company_id" />
  ...
  methods: {
    async updateBtn() {
      ...
      if (this.company.company_name == "") {
        ...
        const result = await axios.post(
          "http://localhost/iubenda_backend/api/admin/company/update.php",
          {
    ...
    async loadData() {
      const result = await axios.get(
        "http://localhost/iubenda_backend/api/admin/company/find.php?id=" +
